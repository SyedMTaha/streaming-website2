...
export default function Episode3Page() {
  const episodeData = {
    ...
    duration: "6 mins",
    rating: "8.1",
    description: "Atom Ant helps prevent a catastrophic ice storm from destroying the ant colony. With his super strength and quick reflexes, he must find a way to stop the advancing ice before it freezes the entire colony.",
    videoUrl: "/videos/atom-ant/episode3.mp4",
