...
export default function Episode5Page() {
  const episodeData = {
    ...
    duration: "6 mins",
    rating: "8.0",
    description: "Atom Ant participates in the annual ant race while trying to stop a cheating competitor. Using his super strength and flying abilities, he must maintain fair play while still trying to win the race.",
    videoUrl: "/videos/atom-ant/episode5.mp4",
