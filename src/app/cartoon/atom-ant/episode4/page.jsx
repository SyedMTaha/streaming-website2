...
export default function Episode4Page() {
  const episodeData = {
    ...
    duration: "6 mins",
    rating: "8.3",
    description: "Atom Ant must rescue a group of ants who accidentally launched themselves into space. Using his super strength and flying abilities, he must navigate the challenges of space travel to bring his fellow ants safely back to Earth.",
    videoUrl: "/videos/atom-ant/episode4.mp4",
