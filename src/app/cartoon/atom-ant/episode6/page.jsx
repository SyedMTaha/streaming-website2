...
export default function Episode6Page() {
  const episodeData = {
    ...
    duration: "6 mins",
    rating: "8.4",
    description: "Atom Ant must defend the ant colony from an invasion of termites. Using his super strength and strategic thinking, he must protect his fellow ants and their home from the destructive termite forces.",
    videoUrl: "/videos/atom-ant/episode6.mp4",
