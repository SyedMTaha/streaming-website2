...
export default function Episode1Page() {
  const episodeData = {
    ...
    duration: "6 mins",
    rating: "8.2",
    description: "Atom Ant's first adventure as he helps a lost baby bird find its way home. When a young bird gets separated from its flock, Atom Ant must use his super strength and flying abilities to reunite the bird with its family while avoiding various obstacles and predators.",
    videoUrl: "/videos/atom-ant/episode1.mp4",
