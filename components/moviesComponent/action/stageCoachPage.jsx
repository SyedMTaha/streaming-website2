...
import Stage from '../../../public/assets/images/movies/action/landscape/Stage Coach.jpg';
    ...
    <div className="min-h-screen text-white bg-gradient-to-t from-[#020d1f] to-[#012256]">
      <section className="max-w-7xl mx-auto py-8 px-4 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3 relative aspect-video rounded-lg overflow-hidden">
          ...
          {isPlaying && (
            <iframe
              src="https://player.vimeo.com/video/1092562326?h=b32d27474f&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479"
              width="100%"
              height="100%"
              frameBorder="0"
